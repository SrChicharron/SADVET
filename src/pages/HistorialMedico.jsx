...
const handleShow2 = () => setShow2(true);
  ...
  const handleSubmit = (e) => {
    ...
    if (cita.id === "" || cita.id === undefined) {
      ...
      const urlAdd = "https://sadvetapi.ashymeadow-04120cb0.westus2.azurecontainerapps.io/sadvet/historial/addHistorial";
      const newCita = {
      ...
      const urlEdit = "https://sadvetapi.ashymeadow-04120cb0.westus2.azurecontainerapps.io/sadvet/historial/updateHistorial";
      const newCita = {
        id: cita.id,
        fecha: formData.get("fecha"),
        descripcion: formData.get("descripcion"),
  ...
  const getAllCitas = async () => {
    let url=""
  if(idMascota===0){
    url = "https://sadvetapi.ashymeadow-04120cb0.westus2.azurecontainerapps.io/sadvet/historial/getHistorialById?id="+idMascota;
  }else{
    url = "https://sadvetapi.ashymeadow-04120cb0.westus2.azurecontainerapps.io/sadvet/historial/getHistorialById?id="+idMascota;
  }
  //const url = "https://sadvetapi.ashymeadow-04120cb0.westus2.azurecontainerapps.io/sadvet/historial/getCitas";
