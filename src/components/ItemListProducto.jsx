...
const ItemListProducto = ({id,cliente,clienteEdit,setClienteEdit,showModal,handleClose,onDelete}) => {
...
const [clienteEditItem, setClienteEditItem] = useState({
  ...
  const deleteCliente = () => {
    ...
    console.log("onDelete");
      ...
      const urlAdd = "https://sadvetapi.ashymeadow-04120cb0.westus2.azurecontainerapps.io/sadvet/producto/deleteProducto";
      const newCliente = {
...
export default ItemListProducto;